...
function SearchResultsPredictiveArticles({
  ...
  return (
    <div className="mb-8" key="articles">
      <h5 className="uppercase mb-4 font-semibold text-sm">Articles</h5>
      <ul>
          ...
          return (
            <li className="mb-2" key={article.id}>
              <Link 
                onClick={closeSearch} 
                to={articleUrl}
                className="flex items-center rounded-md px-3 py-2 transition-colors duration-200 hover:bg-primary hover:text-white cursor-pointer"
              >
                {article.image?.url && (
...
function SearchResultsPredictiveCollections({
  ...
  return (
    <div className="mb-8" key="collections">
      <h5 className="uppercase mb-4 font-semibold text-sm">Collections</h5>
      <ul>
...
function SearchResultsPredictivePages({
  ...
  return (
    <div className="mb-8" key="pages">
      <h5 className="uppercase mb-4 font-semibold text-sm">Pages</h5>
      <ul>
        {pages.map((page) => {
...
function SearchResultsPredictiveProducts({
  ...
  return (
    <div className="mb-8" key="products">
      <h5 className="uppercase mb-4 font-semibold text-sm">Products</h5>
      <ul>
